...
import { NAME, BIO_PARAGRAPHS, SELF_TAGLINE } from '../../constants'
    ...
    <div className="profile-container">
      <div className="profile-row">
        ...
        <div className="profile-info-container">
          ...
          <div className="profile-tagline">{SELF_TAGLINE}</div>
          <div className="profile-bio">{BIO_PARAGRAPHS.map(line => <p>{line}</p>)}</div>
        </div>
      </div>
      <div className="profile-gallery">
        <img src={Graduation} alt="graduation with my partner collin" className="profile-gallery-photo-img" />
